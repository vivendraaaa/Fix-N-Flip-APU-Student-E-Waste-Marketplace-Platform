...
echo "<h2>Fix repair_requests table id column - Correct Order</h2>";
...
// Step 3: Add AUTO_INCREMENT and PRIMARY KEY together
echo "<h3>Step 3: Add AUTO_INCREMENT and PRIMARY KEY together</h3>";
