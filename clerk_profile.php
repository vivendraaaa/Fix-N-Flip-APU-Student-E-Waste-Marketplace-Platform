...
$approved_submissions = $mysqli->query("SELECT COUNT(*) as count FROM device_submissions WHERE status = 'approved'")->fetch_assoc()['count'] ?? 0;
$completed_reviews = $mysqli->query("SELECT COUNT(*) as count FROM in_person_reviews WHERE clerk_id = $user_id AND status = 'completed'")->fetch_assoc()['count'] ?? 0;
$approved_listings = $mysqli->query("SELECT COUNT(*) as count FROM technician_listings WHERE status = 'approved'")->fetch_assoc()['count'] ?? 0;
?>
...
<div class="content-section">
    ...
    <div class="stats-grid" style="margin-bottom: 30px;">
        <div class="stat-card">
            ...
            <div class="value"><?php echo $approved_submissions; ?></div>
        </div>
        <div class="stat-card">
            <h3>Completed Reviews</h3>
            <div class="value"><?php echo $completed_reviews; ?></div>
        </div>
        <div class="stat-card">
